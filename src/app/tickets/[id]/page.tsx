...
export default async function TicketPage({
  ...
  return (
    <main className="mx-auto max-w-5xl space-y-6 px-3 py-6 text-zinc-100 sm:space-y-8 sm:px-4 sm:py-10">
      <div className="flex flex-wrap items-start justify-between gap-4">
        <div>
          ...
          <p className="mt-2 max-w-2xl text-sm text-zinc-300">{ticket.title}</p>
        </div>
              ...
              {ticket.messages.length === 0 ? (
                ...
                ticket.messages.map((m) => (
                  ...
                  >
                    ...
                    <p className="mt-2 whitespace-pre-wrap text-zinc-200">{m.body}</p>
                  </div>
                ))
              )}
            </div>
          ...
          >
            ...
            <dl className="mt-4 space-y-2 text-sm text-zinc-200">
              <div className="flex justify-between gap-3">
                ...
                <dd className="font-medium">{ticket.requestorEmail ?? ticket.contactEmail}</dd>
              </div>
              <div className="flex justify-between gap-3">
                <dt className="text-zinc-500">Account email</dt>
                <dd className="font-medium">{ticket.contactEmail}</dd>
              </div>
              <div className="flex justify-between gap-3">
      ...
      <section className="rounded-2xl border border-zinc-800 bg-[#0b1220] p-5 shadow-sm">
